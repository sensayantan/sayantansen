...
assert(rendered.includes('Research roster checked for this desk'));assert(rendered.includes('BBC News'));assert(rendered.includes('Spectrum — Autism Research News'));
...
console.log('PASS: render, soft editorial targets, shared roundup evidence, balanced HTML, section order, table counts, checksums, duplicate rejection, URL rejection and unavailable slots');
