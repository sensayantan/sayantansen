...
async function loadAbout() {
  try {
    ...
    document.getElementById("profile-photos").innerHTML = renderPhotoGrid(data.profile_photos);
    ...
    document.getElementById("family-photos").innerHTML = renderPhotoGrid(data.family_photos);
  } catch (err) {
    console.error(err);
  }
}
